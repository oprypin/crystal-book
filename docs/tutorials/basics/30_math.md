...
!!! info
    A full list of number methods is available in [the Number API docs][Number] (also check subtypes).
...
!!! info
    A full list of math methods is available in [the Math API docs][Math].
